...
<div class="container-fluid py-4" style="background-color: #f8f9fa; min-height: 100vh;">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col">
            ...
            <p class="text-muted small">Selamat datang kembali, <strong><?= session()->get('nama') ?></strong>. Berikut ringkasan perpustakaan Anda.</p>
        </div>
        <div class="col-auto">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0">⚠️ Perlu Perhatian Admin</h5>
                    <span class="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3">Deadline Dekat</span>
                </div>
                        ...
                        <table class="table align-middle mb-0">
                            <thead class="bg-light">
                                <tr class="text-muted" style="font-size: 0.85rem;">
                                    ...
                                    <th class="py-3 fw-bold">Tenggat Kembali</th>
                                ...
                                <?php if (empty($aktivitas)) : ?>
                                    <tr>
                                        <td colspan="4" class="text-center py-5">
                                            ...
                                            <p class="text-muted mt-2 mb-0">Semua peminjaman masih dalam batas waktu aman.</p>
                                        </td>
                                    </tr>
                                <?php else : ?>
                                    <?php foreach ($aktivitas as $row) : ?>
                                        <tr class="border-bottom">
                                            ...
                                            <td>
                                                <div class="text-danger fw-bold"><?= date('d M Y', strtotime($row['tanggal_kembali'])) ?></div>
                                                <?php 
                                                    $sisa = (strtotime($row['tanggal_kembali']) - time()) / (60 * 60 * 24);
                                                    $sisa = floor($sisa);
                                                ?>
                                                <small class="badge bg-danger bg-opacity-10 text-danger">Sisa <?= $sisa + 1 ?> hari lagi</small>
                                            </td>
